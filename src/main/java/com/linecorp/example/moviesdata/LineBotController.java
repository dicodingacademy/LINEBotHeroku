...
public class LineBotController
{
    ...
    private void getMovieData(String title, Payload ePayload, String targetID) throws IOException{
        ...
        if (userTxt.contains("success")){
            ...
            carouselForUser("https://dicodingacademy.blob.core.windows.net/eventimages/20170112125146109f0470214ce3395b32e48678118a5f.jpeg", ePayload.events[0].source.userId, "Liburan Seru Bersama Bluemix : IST AKPRIND Yogyakarta");
        }
